room_surface = 75
surface_per_paint_bucket = 15
price_of_paint_bucket = 4300
number_of_buckets = 2 * room_surface / surface_per_paint_bucket
price_of_buckets = number_of_buckets * price_of_paint_bucket
print(price_of_buckets, "Ft értékben kell Tibornak festéket vásárolnia.")

minutes_per_surface = 13
hours_per_surface = minutes_per_surface / 60
painter_net_price_per_hour = 2100
